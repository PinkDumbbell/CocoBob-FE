...
function getAge(growing?: boolean, aged?: boolean) {
  ...
  return <p className="text-gray">성견</p>;
}
      ...
      <div className="flex flex-col p-2 gap-2 h-full justify-between">
        <div>
          {product.isAAFCOSatisfied ? (
            <p className="text-primary-dark text-label font-medium relative after:rounded after:block after:absolute after:left-0 after:opacity-25 after:top-2.5 after:bg-primary-brightest after:py-1.5 after:px-9">
              AAFCO 충족
            </p>
          ) : (
            <p className="text-gray text-label font-medium relative after:rounded after:block after:absolute after:left-0 after:opacity-25 after:top-2.5 after:bg-secondary-brighter after:py-1.5 after:px-9">
              AAFCO 미달
            </p>
          )}
